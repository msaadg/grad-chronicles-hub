...
const Search = () => {
  ...
  const searchResults = [
    ...
    },
    {
      ...
      imageUrl: '/images/calculus-slides.jpg'
    },
    {
      id: '3',
      ...
      imageUrl: '/images/env-science.jpg'
    }
  ];
            ...
            {hasResults ? (
              <>
                ...
                <div className="flex justify-center items-center gap-2 mt-8">
                  ...
                  <button className="px-4 py-2 rounded-full hover:bg-gray-100 flex items-center justify-center">
                    Next
                  </button>
                </div>
              </>
